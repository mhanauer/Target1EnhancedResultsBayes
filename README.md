...
posterior_treat2_3 = data.frame(post_2 =  post_prior[,2], post_3 = post_prior[,3])

BEST_out = BESTmcmc(post_treatment3$posterior, post_treatment2$posterior, parallel = TRUE, rnd.seed = 12345)
